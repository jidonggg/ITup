...
const faqData: FAQItem[] = [
  ...
  // 요금 및 결제
  {
    ...
    answer: "상품 4종: 텍스트 상담(5,000원~), 커피챗(15,000원~), 이력서/포폴 첨삭(39,000원~), 모의면접(59,000원~)이 있어요. 멘토 경력에 따라 주니어/시니어/리드 등급별로 가격이 달라요. 번들로 묶으면 더 합리적! 스타터(39,000원), 올인원(79,000원), 풀패키지(99,000원)를 제공해요.",
  },
  {
    category: "요금 및 결제",
    question: "멘토마다 가격이 다른가요?",
    answer: "네! 멘토 경력에 따라 주니어(🌱 1-3년), 시니어(⭐ 3-7년), 리드(👑 7년+) 등급이 나뉘어요. 주니어가 기본 가격이고, 시니어는 1.3배, 리드는 1.6배예요. 예를 들어 커피챗은 주니어 15,000원, 시니어 20,000원, 리드 24,000원이에요.",
  },
  {
    category: "요금 및 결제",
    question: "텍스트 상담은 뭔가요?",
    answer: "카카오톡 오픈채팅으로 3일간 텍스트로 상담받을 수 있어요. 5,000원부터 시작해서 가볍게 질문하기 좋아요. 멘토가 24시간 내에 답변해줘요.",
  },
  {
    category: "요금 및 결제",
