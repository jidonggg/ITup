...
const faqData: FAQItem[] = [
  ...
  // 요금 및 결제
  {
    ...
    answer: "Basic(59,000원/월), Pro(129,000원/월) 두 가지 플랜이 있어요. 단건 커피챗도 가능하고, 첫 15분은 무료예요! 플랜에 따라 커피챗 횟수, 포트폴리오 리뷰, 모의 면접 등 혜택이 달라요.",
  },
  {
    category: "요금 및 결제",
    question: "결제는 어떻게 하나요?",
    answer: "토스페이먼츠를 통해 신용카드, 체크카드, 계좌이체 등 다양한 방법으로 결제할 수 있어요. 구독은 월 정기 결제 방식이에요.",
  },
  {
    category: "요금 및 결제",
    question: "환불은 가능한가요?",
    answer: "서비스 이용 전에 환불 요청하면 전액 환불돼요. 이용 후에는 이용 일수에 따라 부분 환불돼요. 자세한 건 이용약관을 확인해주세요.",
  },
  {
    category: "요금 및 결제",
    question: "구독을 취소하려면 어떻게 하나요?",
    answer: "마이페이지 > 구독/결제 탭에서 '구독 취소' 버튼을 누르면 돼요. 취소해도 결제 기간이 끝날 때까지는 계속 이용할 수 있어요.",
  },
  // 멘토 관련
  {
    category: "멘토 관련",
