...
const iconMap: Record<string, IconRenderer> = {
  ...
  crown: ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.5 17L5 5l4.5 5L12 3l2.5 7L19 5l2.5 12h-19z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.5 17h19v2.5a1 1 0 01-1 1h-17a1 1 0 01-1-1V17z" />
    </svg>
  ),
  ...
  seedling: ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 21V12m0 0c0-3.866 3.582-7 8-7-1 4.5-4 7-8 7zm0 0c0-3.866-3.582-7-8-7 1 4.5 4 7 8 7z" />
    </svg>
  ),
